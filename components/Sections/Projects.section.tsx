  ...
  return (
    <div className="my-16 px-3 font-sen" id="projects">
      ...
      <div className="my-8 flex flex-col items-center justify-center gap-10 sm:flex-row">
        <Link href="https://github.com/sycomora/new-sycomora" passHref>
          <a
          ...
          >
            <div className="flex h-full w-full flex-col items-center justify-center rounded-lg bg-primary px-2 text-center font-medium">
              <p className="text-xl font-semibold">Sycomora Strapi</p>
              <p>Back End Services for Sycomora Website</p>
            </div>
          </a>
        </Link>
        ...
        <Link href="https://github.com/sycomora/new-sycomora" passHref>
          ...
          >
            <div className="flex h-full w-full flex-col items-center justify-center rounded-lg bg-primary px-2 text-center font-medium">
              <p className="text-xl font-semibold">Sycomora Front Page</p>
              <p>Builted with VueJS</p>
            </div>
          </a>
        </Link>
      </div>
